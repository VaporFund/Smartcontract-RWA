...
interface IrswETH is IERC20Metadata {
     ...
     */
    event ETHDepositReceived(address indexed from, uint256 amount, uint256 rswETHMinted, uint256 newTotalETHDeposited, address indexed referral);
     ...
     */
    event MaximumRepricerswETHDifferencePercentageUpdated(uint256 _oldMaximumRepricerswETHDifferencePercentage, uint256 _newMaximumRepricerswETHDifferencePercentage);

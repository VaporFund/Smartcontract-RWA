...
interface IPrimeLRTDepositPool {
    ...
    event AssetDeposit(address indexed depositor, address indexed asset, uint256 depositAmount, uint256 primeEthMintAmount, string referralId);
    ...
    event AssetSwapped(address indexed fromAsset, address indexed toAsset, uint256 fromAssetAmount, uint256 toAssetAmount);

    function depositAsset(address asset, uint256 depositAmount, uint256 minPrimeETHAmount, string calldata referralId) external;
    ...
    function getAssetDistributionData(address asset) external view returns (uint256 assetLyingInDepositPool, uint256 assetLyingInNDCs, uint256 assetStakedInEigenLayer);

    function getETHDistributionData() external view returns (uint256 ethLyingInDepositPool, uint256 ethLyingInNDCs, uint256 ethStakedInEigenLayer);
}
